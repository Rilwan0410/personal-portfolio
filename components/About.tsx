...
{/* Added w-[200px] since I am not using image. If you add image make sure to take out w-[200px] from the typewriter div */}
        ...
        <div>
          ...
          <h2 className="text-4xl font-poppins font-semibold mb-2 dark:text-white max-w-96">
            {aboutData.mainData.jobTitle}
          </h2>
          <p className="text-pColor pt-4 pb-8 dark:text-white/70">
      ...
      {/* <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mt-8">
                ...
                <div className="flex items-center">
                    <div className="pe-2">
                        <h1 className="font-mono font-semibold text-6xl stroke-text"><span className="counter">{counters.projectsDone}</span></h1>
                    </div>
                    <div className="dark:text-white">
                        <h4 className="block text-2xl font-normal mb-1">+</h4>
